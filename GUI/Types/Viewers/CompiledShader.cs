...
namespace GUI.Types.Viewers
{
    public class CompiledShader : IDisposable, IViewer
    {
        ...
        private static SortedDictionary<(VcsProgramType, string), ShaderFile> GetShaderCollection(string targetFilename, VrfPackage vrfPackage)
        {
            ...
            {
                // search the package
                var vcsCollectionName = targetFilename[..targetFilename.LastIndexOf('_')]; // in the form water_dota_pcgl_40
        ...
        private class ShaderRichTextBox : RichTextBox
        {
            ...
            private readonly SortedDictionary<(VcsProgramType, string), ShaderFile> shaderCollection;
                    ...
                    case GlslSource:
                        {
                            ...
                            var richTextBox = CreateRichTextBox(buffer.ToString());
